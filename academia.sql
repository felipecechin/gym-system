...
INSERT INTO `aluno` (`cpf`, `nome`, `dataNasc`, `genero`, `altura`, `biotipo`, `frequenciaSem`, `codigo`)
VALUES ('122121231', 'feeffe', '1990-06-28', 'M', 1.8, 'feeffe', 2, '220245'),
...
INSERT INTO `instrutor` (`login`, `senha`)
VALUES ('felipecechin', '$2a$08$XfgVDvxHrkgONuPcjYC18.l7u7RMLNS6b0V58m.TuqMY4a1rW5V7u');
